...
public class SideBarDataHelperImpl implements ISideBarDataHelper {
    /**
     * 如果需要，
     * 字符-=》拼音，
     */
    @Override
    public ISideBarDataHelper convert(List<? extends BaseIndexPinyinBean> datas) {
     ...
     */
    @Override
    public ISideBarDataHelper fillInexTag(List<? extends BaseIndexPinyinBean> datas) {
        if (null == datas || datas.isEmpty()) {
            return this;
        }
        int size = datas.size();
    ...
    @Override
    public ISideBarDataHelper sortSourceDatas(List<? extends BaseIndexPinyinBean> datas) {
        if (null == datas || datas.isEmpty()) {
            return this;
        }
        convert(datas);
    ...
    @Override
    public ISideBarDataHelper getSortedIndexDatas(List<? extends BaseIndexPinyinBean> sourceDatas, List<String> indexDatas) {
