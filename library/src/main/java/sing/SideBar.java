...
import sing.address.list.R;
import sing.addressList.bean.BaseIndexPinyinBean;
import sing.addressList.helper.ISideBarDataHelper;
import sing.addressList.helper.SideBarDataHelperImpl;
...
public class SideBar extends View {
    ...
    //以下是帮助类
    //汉语->拼音，拼音->tag
    private ISideBarDataHelper mDataHelper;
    //以下边变量是外部set进来的
    ...
    public ISideBarDataHelper getDataHelper() {
        return mDataHelper;
    }
     ...
     * 设置数据源帮助类
     */
    public SideBar setDataHelper(ISideBarDataHelper dataHelper) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.SideBar_sideBarTextSize) {
                textSize = typedArray.getDimensionPixelSize(attr, textSize);
            } else if (attr == R.styleable.SideBar_sideBarPressBackground) {
