...
import list.adapter.MeituanAdapter;
import list.address.sing.addresslistdemo.R;
import list.decoration.DividerItemDecoration;
import list.model.MeiTuanBean;
import list.model.MeituanHeaderBean;
import list.model.MeituanTopHeaderBean;
import list.utils.CommonAdapter;
import list.utils.HeaderRecyclerAndFooterWrapperAdapter;
...
public class ActMeiTuan extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_mei_tuan);
